    ...
    <form id="form1" runat="server">
        <div>
            <h1><span class="auto-style2">
                <img alt="Bob" class="auto-style1" src="PapaBob.png" />Papa Bob&#39;s Pizza and Software</span></h1>
        </div>
        <h1>&nbsp;</h1>
        <p>
            <asp:RadioButton ID="smallRadioButton" runat="server" GroupName="SizeGroup" OnCheckedChanged="smallRadioButton_CheckedChanged" Text="Baby Bob Size (10&quot;) - $10" />
            <br />
